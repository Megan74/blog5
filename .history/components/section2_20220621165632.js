...
return (
    ...
    const MyImage = React.forwardRef(({ href }, ref, {src}) => {
        return (
            <a><Image href={href} ref={ref} src={src}/>
            </a>
        )
      })
...
function Post(){
   ...
   <div className="item">
    ...
    <Link href="/" passHref><a><MyImage src={"/images/img1.jpeg"} className="rounded" width={700} height={450}/></a></Link>
    </div>
    <div className="info flex justify-center flex-col py-4">
    <div className="cat">
        <Link href={"/"}><a className="text-orange-600 font-bold hover:text-orange-800">Business & Travel</a></Link>
