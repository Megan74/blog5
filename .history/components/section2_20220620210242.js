...
function Post(){
   ...
   <div className="item">
    ...
    <Link href={"/"}><Image src={"/Images/img1.jpeg"} className="rounded" width={700} height={450}/></Link>
    </div>
    <div className="info flex justify-center flex-col py-4">
    <div className="cat">
        <Link href={"/"}><a className="text-orange-600 font-bold hover:text-orange-800">Business & Travel</a></Link>
        <Link href={"/"}><a className="text-gray-800 font-bold hover:text-gray-600">-22th june</a></Link>
    </div>
