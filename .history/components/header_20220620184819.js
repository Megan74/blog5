...
<div className="xl:container xl:mx-auto flex flex-col item-center sm:flex-row sm:justify-between text-center py-3">
    <div className="md:flex-none w-96 order-2 sm:order-1 flex justify-center py-4 sm:py-0"></div>
<div>
    <input type="text" className="text-inline" placeholder="Search..."/>
</div>
<div className="shrink w-80 sm:order-2">
    <Link href={'/'}>
    <a className="font-bold uppercase mt-6 text-2xl flex flex-justify-center">Design</a>
    </Link>
    
</div>
<div className= "social mt-6 w-111 h-55 order-3 flex justify-center">
